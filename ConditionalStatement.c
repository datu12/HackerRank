...
//NOTE: I used an array to shorten the statement as there was a repetitive switching if I used a conditional.
...
int main()
{
    ...
    char*Z[10] ={"Greater than 9", "one", "two", "three", "four", "five", "six", "seven", "eight", "nine"};
